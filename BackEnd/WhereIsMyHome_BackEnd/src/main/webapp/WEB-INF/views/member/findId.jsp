        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
            <form id="form-find-id" method="POST" action="">
                ...
                <div class="col-auto text-center">
                    <button type="button" id="btn-find-id" class="btn btn-outline-primary mb-3">
                        아이디찾기
                    </button>
...
<script>
    ...
    document.querySelector("#btn-find-id").addEventListener("click", function () {
        if (!document.querySelector("#username").value) {
            ...
            let form = document.querySelector("#form-find-id");
            // FrontController 반영: 회원의 모든 요청을 하나의 서블릿에서 받아서 처리: MemberController : @WebServlet("/member")
            form.setAttribute("action", "${root}/member/findId");
            form.submit();
        }
    });
